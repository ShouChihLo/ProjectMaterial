...
/*
var tempShape = shape
tempShape.numberOfSides = 5
print(shape.numberOfSides)
 */

// The variable property can still be modified for a constant class object
/*
let constantShape = Shape()
constantShape.numberOfSides = 3
*/
...
var shapeWithName = NamedShape(name: "Triangle")
shapeWithName.numberOfSides = 3

// Actually we can provide multiple initializers based on overloading
/*
 init(name: String) {
    self.name = name
 }
...
// Use convince init as seconary initializers
/*
 convenience init() {
     self.init(name: "Null Shape")
 }
 */
...
// Access the property of one optional object safely
