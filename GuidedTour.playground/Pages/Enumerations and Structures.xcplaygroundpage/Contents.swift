...
// How about setting hearts.rawValue to be "hearts"
/*
 enum Suit: String {
     case spades, hearts, diamonds, clubs
 */
...
// struct types provide default initializers
let threeOfSpades = Card(rank: .three, suit: .spades)
let threeOfSpadesDescription = threeOfSpades.simpleDescription()

// Structs are value-type
/*
var structA = Card(rank: .two, suit: .spades)
var structB = structA
structA.rank = .five
print(structB.rank)
*/

// The variable property cannot be modified for a constant struct instance
// threeOfSpades.rank = .ace

// How about modifying the property inside the instance method
/*
